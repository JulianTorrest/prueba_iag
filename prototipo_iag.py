...
Original file is located at
    https://colab.research.google.com/drive/1dbPDoYiMs19aka9YWGnkDPBK__H0uIjw
"""

!pip install PyPDF2 python-docx openpyxl pandas beautifulsoup4 nltk streamlit transformers

!pip install pyngrok

!pip install SpeechRecognition gTTS langdetect
